            ...
            {markers.map((marker) => {
              ...
              return (
                ...
                >
                  {marker % 10 === 0 && (
                    <>
                      <div className='absolute bottom-0 h-2 bg-neutral-500 w-[1px]' />
                      <span className='absolute bottom-2 text-[10px] text-neutral-500 transform -tranlate-x-1/2'>
                        {marker / 10 + 1}
                      </span>
                    </>
                  )}
                  {marker % 5 === 0 && marker % 10 !== 0 && (
                    <>
                      <div className='absolute bottom-0 h-1.5 bg-neutral-500 w-[1px]' />
                    </>
                  )}
                  {marker % 5 !== 0 && (
                    <>
                      <div className='absolute bottom-0 h-1 bg-neutral-500 w-[1px]' />
                    </>
                  )}
                </div>
              );
...
const Marker = ({
  ...
  return (
    <>
      ...
      >
        <FaCaretDown className='absolute left-1/2 top-full fill-blue-500 transform -translate-x-1/2' />
        <div
